    ...
    >
      ...
      >
        ...
        <Typography variant="body1" sx={{ color: 'text.secondary'}} component={'span'}>
          It may be hard for me to say it, but I am an expert. I know many things, I do hard things, and I push forward with a fierce persistence.
            <ul style={{ textAlign: 'left' }}>
              <li>7+ years software development</li>
              <li>6+ years professional writing</li>
              <li>20+ years momming</li>
              <li>Extensive experience with rest APIs, full-stack development, user interactions, and teen support</li>
            </ul>
        </Typography>
      </Box>
